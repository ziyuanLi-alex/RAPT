...
TRANSLATIONS = {
    LOCALE_ZH_CN: {
        ...
        "home.description": "面向 RFID RSSI、视频与 SkellyCam 同步实验的数据采集工具",
        "home.reader": "RFID 读写器",
        "home.video_skellycam": "视频 / SkellyCam",
        "home.not_connected": "未连接",
        "home.check_connection": "检查连接",
        "home.capture_pages": "见采集页面",
        "home.capture_entry": "采集入口",
    ...
    LOCALE_EN_US: {
        ...
        "home.description": "Data collection for RFID RSSI, video, and SkellyCam synchronized experiments",
        "home.reader": "RFID Reader",
        "home.video_skellycam": "Video / SkellyCam",
        "home.not_connected": "Disconnected",
        "home.check_connection": "Check",
        "home.capture_pages": "Use capture pages",
        "home.capture_entry": "Capture",
